...
def main() -> None:
    ...
    if ENGINE_TYPE == "ollama":
        ...
        print(f"  - GET  http://127.0.0.1:{PORT}/api/tags")
    print(f"  - POST http://127.0.0.1:{PORT}/v1/chat/completions")
    print(f"  - POST http://127.0.0.1:{PORT}/v1/completions")
    print(f"  - POST http://127.0.0.1:{PORT}/generate")
    print(f"  - POST http://127.0.0.1:{PORT}/admin/fail/N")
